...
import static com.example.android.complaintcrmd.CommonUtilities.EXTRA_MESSAGE;
...
public class Main2Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            alert.showAlertDialog(Main2Activity.this,
    ...
    protected void onDestroy() {
        ...
        try {
            ...
            Log.v("error main2activity", e.getMessage());
        }
        super.onDestroy();
    }
